public class ExercicioJava {
    /**
     * Declare uma variável do tipo inteiro chamada "idade" e atribua a ela o valor 25. Em seguida, imprima a idade com uma mensagem adequada.
     */
    public static void exercicio01() {
        int idade = 25;
        System.out.println("A idade do professor é: " + idade);
    ...
    public static void exercicio07() {
        char letra = 'B';
        System.out.println("A letra esolhida é: " + letra);
    ...
    public static void exercicio13() {
        char opcaoMenu = 'C';
        System.out.println("A opção é a letra: " + opcaoMenu);
    ...
    public static void exercicio15() {
        int largura = 5;
        int altura = 10;
        System.out.println("O área do retangulo é: " + altura * largura);
